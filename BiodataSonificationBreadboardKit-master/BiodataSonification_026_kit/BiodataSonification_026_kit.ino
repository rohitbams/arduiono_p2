...
#include <MIDI.h>
int maxBrightness = 190; // **CHANGE HERE FOR BRIGHTNESS**
...
int currScale = 8; //current scale, default Chrom **CHANGE HERE FOR SCALE**
...
int channel = 1;  //setting channel to 11 or 12 often helps simply computer midi routing setups **CHANGE HERE FOR CHANNEL**
...
float threshold = 2;   //2.3;  //change threshold multiplier **CHANGE HERE FOR THRESHOLD**
          ...
          case 1: //this is the main selection menu
            ...
            switch(value) {
              case 0:
                ...
                Serial.print("THRESHOLD MODE - set change threshold multiplier\n");
                return; 
                break;
              case 1:
                scaleMode(); //set note scale
                Serial.print("SCALE MODE - set note scale\n");
                return;
                break;
              case 2:
                channelMode(); //set MIDI output channel
                Serial.print("CHANNEL MODE - set MIDI output channel\n");
                return;
                break;
              case 3:
                brightnessMode(); //set LED max brightness
                Serial.print("BRIGHTNESS MODE - set LED max brightness\n");
                return;
                break;
              case 4:
